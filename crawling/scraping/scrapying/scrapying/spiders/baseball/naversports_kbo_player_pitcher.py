...
class NaversportsKboPlayerPitcherSpider(scrapy.Spider):
    """KBO 타자 선수 기록을 수집하는 스파이더.

    실행 방법:
        scrapy crawl naversports_kbo_player_pitcher                                    # 현재 시즌 전체 팀
        scrapy crawl naversports_kbo_player_pitcher -a season=2025                      # 특정 시즌
        scrapy crawl naversports_kbo_player_pitcher -a team_code=OB                     # 특정 팀 (두산)
        scrapy crawl naversports_kbo_player_pitcher -a season=2026 -a team_code=OB      # 특정 시즌 + 특정 팀
    ...
    name: str = "naversports_kbo_player_pitcher"
    ...
    def parse(self, response: TextResponse) -> Iterator[CrawledItem]:
        ...
        item["data_type"] = "naversports_kbo_player_pitcher"
