...
class NaversportsKboSeasonsPlayersPitcherSpider(scrapy.Spider):
    """KBO 타자 선수 기록을 수집하는 스파이더.

    실행 방법:
        scrapy crawl naversports_kbo_seasons_players_pitcher -a season=2026 -a team_code=OB
    ...
    name: str = "naversports_kbo_seasons_players_pitcher"
    ...
    def parse(self, response: TextResponse) -> Iterator[CrawledItem]:
        ...
        item["data_type"] = "naversports_kbo_seasons_players_pitcher"
